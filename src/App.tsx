...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="footer section-wrap"><a className="brand" href="#top"><span className="brand-mark">K</span><span>KALMUX<span className="brand-cursor">_</span></span></a><p>© 2026 Kalmux. Built with intent.</p><a href="#top" className="back-top">back to top <ArrowUpRight size={14} /></a></footer>
    </div>
  );
}
